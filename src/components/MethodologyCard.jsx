...
export default function MethodologyCard({ steps }) {
  ...
  return (
    <div className="panel-aerospace p-5 space-y-3">
      ...
      {isOpen && (
        <div className="pt-3 border-t border-[#20252b] space-y-2 text-xs font-mono-tech">
          <p className="text-slate-400 text-[11px] mb-3">
            SatQuery AI implements scientifically rigorous Earth Observation workflows. Step-by-step execution path:
          </p>

          <div className="space-y-2">
            {steps.map((stg, idx) => (
              <div key={idx} className="flex items-center gap-3 bg-[#07090b] p-2.5 rounded border border-[#20252b]">
                <div className="w-5 h-5 rounded bg-[#11151a] text-[#00f0ff] font-bold flex items-center justify-center text-xs flex-shrink-0 border border-[#00f0ff]/30">
                  {idx + 1}
                </div>
