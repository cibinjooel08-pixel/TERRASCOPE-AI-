    ...
    <div className="panel-aerospace p-5 space-y-4 tech-corners">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 font-mono-tech">
        {hotspots.map((spot, idx) => (
          <div key={idx} className="bg-[#060b12] p-3.5 rounded border border-[#152232] space-y-2 hover:border-[#00f0ff]/40 transition-colors">
            ...
            <div className="text-[11px] text-slate-400 space-y-1 pt-1.5 border-t border-[#152232]">
              <div className="flex items-center justify-between">
